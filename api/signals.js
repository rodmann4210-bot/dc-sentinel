...
const BASELINES = {air_total:{mean:62,std:18},air_mil:{mean:2.1,std:1.4},fed_reg:{mean:0.9,std:1.1},tfr_count:{mean:4.2,std:2.0},hotel_rate:{mean:425,std:105},car_rental:{mean:68,std:22}};
...
module.exports={fetchAircraft,fetchFederalRegister,fetchTFRs,fetchHotelRate,fetchCarRental,scoreSignals,getRedis};
